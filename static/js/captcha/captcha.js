...
+"<img src='"+capt_cdn+"img/loadimg.png' width='24' height='24' class='load_img capt_loc'/></div><div class='capt_txt_box capt_txt_doc'>　正在加载数据...</div></div>"+"<div style='display:none'><div class='capt_img_box capt_img_erc'><div class='capt_img capt_loc'></div></div><div class='capt_txt_box capt_txt_erc'>　操作过于频繁，请稍后重试</div></div>"+"</div>";for(var i=0;i<nl.length;i++){nl[i].innerHTML=html;}}function c_ajaxCaptcha(json,name)
